...
//LETRA A: Criar uma função inicializa que recebe o vetor de ponteiros e inicializa cada elemento com NULL, o protótipo é mostrado a seguir.
struct aluno{
    char nome[81];
    int idade;
    char matricula[8];
...
int main() {
    int n = 3;
    Aluno** tab = (Aluno**)malloc(sizeof(Aluno*)*n);
